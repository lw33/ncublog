(function (z) {
    ...
    var Uv = function (a) {
        ...
        var b = a.fO;
        a.Pb = new z.Hv;
        a.Pb.Dz = '\x3cspan style\x3d"font-style: normal;color: #999;"\x3e内容\x3c/span\x3e';
        a.Pb.w(b);
        a.Pb.init();
        a.Pb.rg();
        z.Uj && !z.Vj || Kv(a.Pb);
    ...
    var cw = function (a) {
        ...
        a = Gr(a);
        var b = new bw;
        3 > a ? (b.level = 3, b.ye = "博客字数太少了吧", b.name = "tooshort") : 40 < a && 51 >= a ? (b.level = 1, b.ye = '还可以输入 \x3cspan class\x3d"warning"\x3e' + (51 - a) + "\x3c/span\x3e 字", b.name = "buffer") : 51 < a && (b.level = 3, b.ye = '已超出 \x3cspan class\x3d"error"\x3e' + (a - 51) + "\x3c/span\x3e 字", b.name = "toolong");
        return b
    };
    var dw = function (a) {
        a = a.Pb;
