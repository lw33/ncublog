...
<head>
    ...
    <link rel="stylesheet" media="all" href="../styles/detail.css">

</head>
<body class="zhi ${bodyclass!}">
<div role="navigation" class="zu-top">
    <div class="zg-wrap modal-shifting clearfix" id="zh-top-inner">
        <a href="/" class="zu-top-link-logo" id="zh-top-link-logo" data-za-c="view_home" data-za-a="visit_home" data-za-l="top_navigation_zhihu_logo"></a>
        <div class="top-nav-profile">
            ...
            <a href="/user/${user.id!}" class="zu-top-nav-userinfo " id=":0" role="button" aria-haspopup="true" aria-activedescendant="">
                ...
                <img class="Avatar" src="${user.headUrl!"/img/logo.jpg"}" alt="${user.name!}">
        ...
        <div role="search" id="zh-top-search" class="zu-top-search">
            <form method="GET" action="/search" id="zh-top-search-form" class="zu-top-search-form">
                <label for="q" class="hide-text">NCUBlog 搜索</label><input type="text" class="zu-top-search-input" id="q" name="q" autocomplete="off" value="${keyword!}" placeholder="搜索你感兴趣的内容..." role="combobox" aria-autocomplete="list">
        ...
        <div id="zg-top-nav" class="zu-top-nav">
            <ul class="zu-top-nav-ul zg-clear">
                <li class="zu-top-nav-li current" id="zh-top-nav-home">
                    <a class="zu-top-nav-link" href="/" id="zh-top-link-home" data-za-c="view_home" data-za-a="visit_home" data-za-l="top_navigation_home">
            ...
            <#if user??>
                <li class="zu-top-nav-li " id="zh-top-nav-explore">
                    <a class="zu-top-nav-link" href="/pullfeeds">
                        <i class="iconfont icon-tubiao_huabanfuben"></i>
                        动态
                    </a>
                </li>
                <#--#if ($user)-->
                ...
                <li class="top-nav-noti zu-top-nav-li ">
                    <span class="zu-top-nav-link" href="#" id="zh-top-nav-count-wrap" role="button"><span class="mobi-arrow">

                    </span>
                        <i class="iconfont icon-send"></i>
                        发送
                        <span id="zh-top-nav-count" class="zu-top-nav-count zg-noti-number" style="display: none;">0</span></span>
                </li>
                <#--#end-->
                </#if>
            </ul>
