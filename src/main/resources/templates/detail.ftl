        ...
        <div class="zu-main-content-inner">
            ...
            <div id="zh-question-title" data-editable="true" class="zm-editable-status-normal">
                <h2 class="zm-item-title">
                    ...
                    <span class="zm-editable-content">${blog.title!}</span>

                </h2>
            </div>
            <div id="zh-question-detail" class="zm-item-rich-text zm-editable-status-normal">
                <div class="zm-editable-content">${blog.content!}</div>
            </div>
            <div class="zm-side-section">
                <div class="zm-side-section-inner" id="zh-question-side-header-wrap">
                    ...
                    <button class="follow-button zg-follow zg-btn-white js-follow-question" data-id="${blog.id?c}"
                            data-status="1">
                        取消关注
                    </button>
                    <#--#else-->
                    <#else>
                    <button class="follow-button zg-follow zg-btn-green js-follow-question" data-id="${blog.id?c}">
                        关注博客
                    </button>
                    <#--#end-->
                    </#if>
                    <div class="zh-question-followers-sidebar">
                        <div class="zg-gray-normal">
                            <#--<a href="javascript:void(0);"><strong class="js-user-count">${followUsers.size()!}</strong></a>人关注该博客-->
                        </div>
                        <div class="list zu-small-avatar-list zg-clear js-user-list">
                        <#if followUsers?? && (followUsers?size > 0)>
                            ...
                            <a class="zm-item-link-avatar js-user-${vo.id?c}" href="/user/${vo.id?c}"
                               data-original_title="${vo.name!}">
                                <img src="${vo.headUrl!'/img/logo.png'}"
                ...
                <div class="zm-item-answer  zm-item-expanded js-comment">
                    ...
                    <div class="answer-head">
                        <div class="zm-item-answer-author-info">
                            <a class="zm-item-link-avatar avatar-link" href="/user/${comment.user.id?c}" target="_blank" data-tip="p$t$yingxiaodao">
                                <img src="${comment.user.headUrl!"/img/logo.png"}" class="zm-list-avatar avatar"></a>
                    ...
                    <div class="zm-item-meta answer-actions clearfix js-contentActions">
                        <div class="zm-meta-panel">
                            ...
                            <#if user.id = comment.comment.userId>
                                <a href="/comment/delete/${comment.comment.id}" >
                                    删除
            ...
            <form action="/comment/add" method="post">
                <input type="hidden" name="blogId" value="${blog.id?c}"/>
            <div id="zh-question-answer-form-wrap" class="zh-question-answer-form-wrap">
                <div class="zm-editable-editor-wrap" style="">
                    ...
                    <div class="zm-command clearfix">
                            <span class=" zg-right">
                                <button type="submit" class="submit-button zg-btn-blue">发布评论</button></span>
                    </div>
                </div>
            </div>
            </form>
