                    ...
                    <div id="zh-profile-follows-list">
                        <div class="zh-general-list clearfix">
                            <div class="zm-profile-card zm-profile-section-item zg-clear no-hovercard">
                                <div class="zg-right">
                                    <#if profileUser.user.id != user.id>
                                        ...
                                        js-follow-user" data-id="${profileUser.user.id?c}">关注</button>
                                        <#--#end-->
                                        </#if>
                                    </#if>
                                </div>
                                ...
                                <div class="zm-list-content-medium">
                                    ...
                                    <div class="details zg-gray">
                                        <a target="_blank" href="/user/${profileUser.user.id}/followers" class="zg-link-gray-normal">${profileUser.followerCount?c}粉丝</a>
                                        /
                                        <a target="_blank" href="/user/${profileUser.user.id}/followees" class="zg-link-gray-normal">${profileUser.followeeCount?c}关注</a>
                                        /
                                        <a target="_blank" href="#" class="zg-link-gray-normal">${profileUser.commentCount?c} 回答</a>
                                        /
                            ...
                            <div class="zm-profile-card zm-profile-section-item zg-clear no-hovercard">
                                ...
                                <div class="zm-list-content-medium">
                                    ...
                                    <div class="details zg-gray">
                                        ...
                                        <p>性别：<#if profileUser.user.gender = 0>男<#else>女</#if></p>

                                        <p>职业：${profileUser.user.vocation!}</p>
                                        <p>出生日期：${profileUser.user.birth?date}</p>
                                        <p>注册时间: ${profileUser.user.registerDate?date}</p>
                                        <p style="width: 60%;">个人简介: ${profileUser.user.introduction!}</p>
                                         <#if profileUser.user.id = user.id>
                                            <a href="/user/edit" style="display: inline-block;padding: 0 16px;
                                                                                    font-size: 14px;line-height: 32px;color: #0084ff;
                                                                                    text-align: center;cursor: pointer;background: none;border: 1px solid #0084ff;
                                                                                    border-radius: 3px;padding: 0 16px;position: absolute;right: 0px;
                                                                                    bottom: 8px;text-decoration: none">编辑资料</a>
                                         </#if>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="feed-meta">
                                            <div class="zm-item-meta answer-actions clearfix js-contentActions">
                                                <div class="zm-meta-panel">
                                                    ...
                                                    <a  href="/blog/delete/${vo.blog.id?c}" name="addcomment" class="meta-item toggle-comment js-toggleCommentBox" >
                                                        <i class="z-ico-close"></i>删除博客</a>
